      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-input class="textarea-style" type="textarea"
                    value="alert tcp any any -> any 1433 (msg: ET SQL MSSQL sp_replwritetovarbin - potential memory overwrite case 1 flow:to_server,established; content:s|00|p|00|_|00|r|00|e|00|p|00|l|00|w|00|r|00|i|00|t|00|e|00|t|00|o|00|v|00|a|00|r|00|b|00|i|00|n nocase; sid:2008909; rev:2;)"></el-input>
...
<script>
  export default {
    ...
    methods: {
      /** 用户列表初始化数据 **/
      InitUserList() {
        this.$http.get('../../../../../../static/json/rule-request.json').then(res => {
