  ...
  <div>
    ...
    <div class="common-box">
      <div style="text-align:center;margin-bottom: 20px;">
        <span @click="openAddCombinationRule" class="button button-raised button-primary button-pill button-small">添加请求规则</span>
      </div>
      <Table></Table>
    </div>
    <!--授权码dialog-->
...
<script>
  import Table from './table/rule-request-table'
