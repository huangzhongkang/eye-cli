  ...
  <div>
    ...
    <div class="common-box">
      <div style="text-align:center;margin-bottom: 20px;">
        <span @click="openAddCombinationRule" class="button button-raised button-primary button-pill button-small">添加组合规则</span>
        <span @click="openAddCombinationRule" class="button button-raised button-primary button-pill button-small">快速添加组合规则</span>
      </div>
      <Table></Table>
    </div>
    <!--授权码dialog-->
    ...
    <dialogRuleAddCombination @dialogVisibleClose="dialogVisibleClose"
                              :dialogVisible="dialogVisible_ruleAddCombination" :Show_rule_addCombination="true"></dialogRuleAddCombination>
  </div>
</template>

<script>
  import Table from './table/rule-combination-table'
