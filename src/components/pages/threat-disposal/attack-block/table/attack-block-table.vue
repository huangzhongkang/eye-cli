<template>
  <div class="userList-wrap clearfix">
    ...
    <el-table
        class="element-table-style border-element-table element-tableHeight-72px"
        :data="tableDataWatch">
      <!--<el-table-column-->
          <!--label="序号"-->
          <!--width="40"-->
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-input class="textarea-style-300px textarea-styleHeight-60px" type="textarea"></el-input>
        </template>
      </el-table-column>
      <el-table-column
          label="阻断次数"
...
<script>
  export default {
    ...
    methods: {
      /** 用户列表初始化数据 **/
      InitUserList() {
        this.$http.get('../../../../../../static/json/attack-block-table.json').then(res => {
