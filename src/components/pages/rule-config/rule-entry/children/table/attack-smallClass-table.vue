<template>
  <div class="userList-wrap clearfix">
    ...
    <el-table
      class="element-table-style border-element-table element-tableHeight-110px"
      :data="tableDataWatch">
      <el-table-column
        label="序号"
        width="60"
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <div :class="[scope.row.ruleType === '本地规则' ? 'btn btn-primary btn-xs': 'btn btn-info btn-xs']">
            {{scope.row.ruleType}}
          </div>
        </template>
      </el-table-column>
      ...
      <el-table-column
        label="业务大类"
        prop="businessBigClass">
        <template slot-scope="scope">
          <div style="clear: both;">
            <el-checkbox class="pull-left">网络设备</el-checkbox>
          </div>
          <div style="clear: both;">
            <el-checkbox class="pull-left">操作系统</el-checkbox>
          </div>
          <div style="clear: both;">
            <el-checkbox class="pull-left">业务系统</el-checkbox>
          </div>
          <div style="clear: both;">
            <el-checkbox class="pull-left">数据库系统</el-checkbox>
          </div>
        </template>
      </el-table-column>
      <el-table-column
        ...
        prop="desc">
        <template slot-scope="scope">
          <el-input class="textarea-style" type="textarea"
                    placeholder="[ATT]：攻击名称，[SIP]：攻击源IP，[DIP]：资产IP，[ANUM]：合计攻击次数，[ASTU]：攻击状态，[DNUM]：资产台数，[BR]：换行"></el-input>
...
<script>
  export default {
    ...
    methods: {
      /** 用户列表初始化数据 **/
      InitUserList() {
        this.$http.get('../../../../../../static/json/attack-small-class.json').then(res => {
